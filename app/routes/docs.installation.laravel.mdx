...
<ul>
  ...
  <li>Role list management</li>
  <li>Permission list management</li>
  <li>Password reset</li>
  <li>Email verification</li>
  <li>Update profile</li>
  <li>Delete profile</li>
  <li>Dark mode support</li>
  <li>Multiple language support (mcamara/laravel-localization and i18next)</li>
  <li>SQLite by default, configurable to MySQL or PostgreSQL</li>
</ul>
